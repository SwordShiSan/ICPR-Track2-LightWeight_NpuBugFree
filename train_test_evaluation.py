...
class Trainer(object):
    def __init__(self, args):
        ...
        trainset = TrainSetLoader(self.train_dataset_dir, img_id=self.train_img_ids, base_size=args.base_size,
                                  crop_size=args.crop_size, transform=input_transform, suffix=args.suffix)
        testset = TestSetLoader(self.test_dataset_dir, img_id=self.val_img_ids, base_size=args.base_size,
                                crop_size=args.crop_size, transform=input_transform, suffix=args.suffix)
        evalset = TestSetLoader(self.test_dataset_dir, img_id=self.val_img_ids, base_size=args.base_size,
                                crop_size=args.crop_size, transform=input_transform, suffix=args.suffix)
        ...
        self.test_data = DataLoader(dataset=testset, batch_size=args.test_batch_size, num_workers=args.workers,
                                    drop_last=False)
        self.eval_data = DataLoader(dataset=evalset, batch_size=args.eval_batch_size, num_workers=args.workers,
                                    drop_last=False)
