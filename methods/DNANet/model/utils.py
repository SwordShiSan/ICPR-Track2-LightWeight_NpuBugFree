...
class TrainSetLoader(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        mask = Image.open(label_path).convert("P")  # mask有少部分是24位深度的3通道,将其转为1个通道
        ...
        # print(img_path,": ",img.shape,"--",mask.shape)
...
def save_model(mean_IOU, FA, PD, best_iou, save_dir, save_prefix, train_loss, test_loss, recall, precision, epoch, net):
