...
class Trainer(object):
    def __init__(self, args):
        ...
        if args.mode == 'TXT':
            ...
            self.len_val_img_ids = len(val_img_ids)
    ...
    def testing(self, epoch):
        ...
        with torch.no_grad():
            ...
            # FA, PD = self.PD_FA.get(self.len_val_img_ids)
            # print(f"Epoch {epoch}, FA: {FA}, PD: {PD}")
        # save high-performance model
        save_model(mean_IOU, 0, 0, self.best_iou, self.save_dir, self.save_prefix,
